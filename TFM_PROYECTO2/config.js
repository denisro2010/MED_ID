...
const config = {
    ...
    walletName: `${process.env.USERNAME || 'denis'}_wallet`,
    ...
    userInformation: {
        name: process.env.NAME || 'Denis Ionut Stefanescu',
        email: process.env.EMAIL || 'dstefanescu@uoc.edu',
        tax_id: process.env.TAX_ID || '123456789',
        icon_src: process.env.ICON_SRC || 'https://cdn3.iconfinder.com/data/icons/black-easy/512/538738-school_512x512.png',
        username: process.env.USERNAME || 'denis',
