...
exports.sendRequest = async function (theirDid, encryptedMessage) {
    ...
    let [, credentialDefinition] = await indy.issuer.getCredDef(await indy.pool.get(), await indy.did.getEndpointDid(), credentialOffer.cred_def_id); 
...
exports.acceptRequest = async function(theirDid, encryptedMessage) {
    ...
    for(let attr of schema.attrNames) {
	    ...
	    case "Género":
                ...
                break;
            case "Dirección":
                value = "Avenida de Salburua 12 5ºB, Vitoria-Gasteiz, ES-PV";
                break;
	    case "Teléfono de contacto":
                value = "+0034638789045";
                break;
	    case "e-mail":
                value = "dstefanescu@uoc.edu";
                break;
            case "DNI":
                value = "123456789";
                break;
            case "Fecha de nacimiento":
                value = "07/01/1997";
                break;
 	    case "Ocupación u oficio":
                value = "Estudiante";
                break;
	    case "Enfermedades":
                value = "Rinitis alérgica crónica";
                break;
	    case "Medicamentos que toma actualmente":
                value = "Nasonex spray nasal 1 vez al día";
                break;
 	    case "Antecedentes quirúrgicos":
                value = "---";
                break;
	    case "Uso de implantes o dispositivos":
                value = "---";
                break;
	    case "Alergias a medicamentos":
